    ...
    <div className='desapego'>
        ...
        <div className='sidebarDesapego'>
              ...
              <div className='cadastrarProdutoCallForm'>
                ...
                <div className='filtrar'>
                  ...
                  <div className='itemList'>
                    ...
                    <h5 className='filtraritem'>Cidade<i className='filtraritemSpace'></i>  <i className="fa-solid fa-city"></i></h5>
                  </div>
                </div>
              </div>
          ...
          <form className='formProdutoDesapego' onSubmit={handleSubmit} key={file}>
              ...
              <input className='inputProduto' type='text' placeholder='CEP' onChange={(e)=> setCepp(e.target.value)} onBlur={Cepfuncion} />
              <select className='inputProduto' type='text' placeholder='Categoria' onChange={(e)=> setCat(e.target.value)}>
